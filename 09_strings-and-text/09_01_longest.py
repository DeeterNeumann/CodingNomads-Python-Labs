...
print("Longest German Word is:", len(longest_german_word), "characters")
print("Longest Hungarian Word is:", len(longest_hungarian_word), "characters")
print("Longest Finnish Word is:", len(longest_finnish_word), "characters")
print("Strong password is:", len(strong_password), "characters")

print("The string", strong_password, "is the longest string.")
